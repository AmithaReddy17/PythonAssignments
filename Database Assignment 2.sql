...
#2#
SELECT OrderID, MIN(quantity) AS min_quantity, MAX(quantity) AS max_quantity
FROM order_details
GROUP BY OrderID;

#3#
SELECT OrderID, SUM(quantity) AS total_quantity, AVG(quantity) AS avg_quantity
FROM order_details
GROUP BY OrderID;
...
#8#
SELECT city, COUNT(DISTINCT CustomerID) AS count
FROM customers_e
GROUP BY city;
...
#10#
CREATE TABLE Supplier_detail AS
SELECT * FROM suppliers;

#11#
DELETE FROM customers_e
